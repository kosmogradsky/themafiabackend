...
export class initial1617190578746 implements MigrationInterface {
    name = 'initial1617190578746'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "player" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "is_alive" boolean NOT NULL DEFAULT true, "is_exposed" boolean NOT NULL DEFAULT false, "fouls" integer NOT NULL DEFAULT '0', "role" character varying NOT NULL DEFAULT '', "gameId" uuid, CONSTRAINT "PK_65edadc946a7faf4b638d5e8885" PRIMARY KEY ("id"))`);
